...
use Stefanius\DagVanDeWeekBundle\BreadcrumbGenerator\DefaultTitleBuilder;
...
class NewsController extends BaseController
{
    ...
    public function showAction(Request $request, $slug)
    {
        ...
        return $this->render('StefaniusDagVanDeWeekBundle:News:show.html.twig', array(
            'page' => $news,
        ), null, $request);
    }
    ...
    public function showMainNewsPageAction(Request $request)
    {
        ...
        return $this->render('StefaniusDagVanDeWeekBundle:News:index.html.twig', array(
            'newsitems' => $newsitems,
            'page'      => $page,
        ), null, $request);
    }
